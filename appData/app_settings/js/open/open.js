(function () {
    var viewportMain = document.getElementById("viewportScrollYSettingsMain");
    var contentMain = document.getElementById("contentScrollYSettingsMain");
    if (viewportMain && contentMain && typeof addScroll === "function") {
        addScroll(viewportMain, contentMain);
    }

    window.getSettingsAppTargetId = function (el) {
        if (!el) return null;
    ...
    window.settingsItemEvent_app_settings = function (e) {
        var appId = window.getSettingsAppTargetId(e.currentTarget);
        if (!appId) return;
    ...
    var settingsAppEl = document.getElementById("app_settings");
    if (settingsAppEl) {
        settingsAppEl.querySelectorAll(".settingsItem").forEach(function (item) {
        ...
        settingsAppEl.querySelectorAll(".appInApp.open").forEach(function (panel) {
